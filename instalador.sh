...
#   4. Acrescenta PATH e atalhos no .bashrc (bloco marcado, idempotente).
#   5. Faz o /usr/bin/emulationstation-standalone chamar o iniciar.sh do
...
URL_SQUASHFS="${1:-https://github.com/<usuario>/<repo>/releases/latest/download/jukebox.squashfs}"
# As quatro variaveis abaixo aceitam override por ambiente -- serve pra
# testar o instalador contra um destino falso (ver dist/testar-instalador.sh),
# nunca precisa mexer nisso pra instalar de verdade.
...
# ----------------------------------------------------------------------
# 4. .bashrc -- PATH + atalhos, num bloco marcado (idempotente: apaga o
...
# ----------------------------------------------------------------------
# 5. emulationstation-standalone: desviar para o iniciar.sh do jukebox
# ----------------------------------------------------------------------
